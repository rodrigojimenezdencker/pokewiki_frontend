        ...
        return (
            <div className={`card type${this.props.type1Id}`}>
                ...
                <div className="name-type_container">
                    <p>{this.props.name}</p>
                    <img src={secondaryTypesImages[this.props.type1Image]} alt={this.props.type1Name} className="type_image" />
                    <img src={secondaryTypesImages[this.props.type2Image]} alt={this.props.type2Name} className="type_image" />
                </div>
            </div>
        )
    }
